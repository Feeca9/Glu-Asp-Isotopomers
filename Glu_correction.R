...
gm_cor<- read_excel("Input Matrices Glu Asp.xlsx", 
                    sheet = "GluMatrixNaturAbundanCorrection", range = "B2:AG89", col_names = FALSE)
...
cal.iso <-coef(glmnet(gm_cor,Glu, lambda = 0, lower.limits = 0, intercept = FALSE, thresh = 1e-31,upper.limits = 1))[-1]
